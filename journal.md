...
# February 2, 2026 
Professional behavior in shared spaces matters because things like hygiene, noise level, and self control can affect how comfortable and focused others feel. One habit I can improve is being more aware of my volume and actions so I am respectful of everyone around me. “I used AI to assist with this entry.”

# February 11, 2026
Yes, I did enjoy the football game on sunday it was alright but the game could've been better. Yes I did watch super bowl LX it was a nice game to watch but i feel like it was short. My opinion on the super bowl is that the half time show was amazing amd great but the game just felt rigged or not real. “I used AI to assist with this entry.”

# February 24, 2026
I think the most important technology at the 2026 Winter Olympics was high speed timing because it improved fairness. It was used in events like speed skating and skiing to record exact finish times, even down to hundredths of a second. This made the results more accurate and fair, especially in very close races, so the right athlete won. “I used AI to assist with this entry.”
...
## Part C 
I would prefer the Software Engineer job at USAA. One reason is that this job requires a Bachelor's degree in computer science and skills in coding languages like Java or Python. Another reason is that the job focuses on building and improving software, which requires problem solving and teamwork. These requirements match my interests because I like working with technology and learning how programs work. I also enjoy solving problems and figuring out how to fix things. Taking computer or technology classes now can help me prepare for this carrer growth and good oppurtunities in the tech field. Overall, becoming a software engineer fits my goals and interests. “I used AI to assist with this entry.”

# March 23, 2026 
I chose Duke Blue Devils to win it all because they have a strong team, good coaching, and can score in big moments. So far, my bracket is doing okay but not perfect. One result that surprised me was some lower-ranked teams beating higher seeds, which shows anything can happen in the tournament. Using data like stats and rankings can help make better picks because it shows how good teams really are instead of just guessing. A computer program could use this data to compare teams and find patterns, which helps make smarter predictions. Jobs like data analysts, sports analysts, and programmers all work with this kind of sports data. “I used AI to assist with this entry.”

# March 30, 2026
Upsets happen in March Madness because games are not just about stats, they also depend on how players feel and perform that day. One example is when a lower seeded team like a 12 seed beats a 5 seed, which happens a lot and always surprises people. I think this happens because the underdog team plays harder and has nothing to lose, while the better team might feel too confident. Things like pressure, injuries, and team chemistry are hard for computers to predict because they are not numbers you can easily measure. Even if a team has better stats, they can still lose if they have a bad game or miss shots. If I made a program to predict games, it would struggle with things like momentum and emotions during the game. To improve it, I would try to include more recent performance and maybe how teams play under pressure, but it still wouldnt be perfect. “I used AI to assist with this entry.”

# April 9, 2026
### Paragraph 1 (Claim + Plan)
Our strategy to convince the AI is to show it that humans can learn and adapt, which will make the AI feel less worried about our safety. We plan to start by letting a few people out of the ship for very short, controlled periods. We'll have lots of data to show the AI that we can follow instructions and learn from any problems that come up. We'll focus on using facts and logic that the AI can understand, because it's a machine, and show it that letting us out carefully is actually a better way to keep us safe in the long run. “I used AI to assist with this entry.”

### Paragraph 2 (Evidence + Reasoning)
This plan would work by carefully testing our ability to survive outside. First, a small, trained group would go out with devices that track their every move. The AI might worry about us getting hurt by the environment, but we'll give it data from these tests that proves we can follow safety rules and learn from our mistakes. For example, if someone trips, we'll show the AI how they learned to be more careful next time. If the AI sees that these controlled outings don't lead to anyone getting hurt and that we are improving, it will build confidence in our ability to survive. This proves to the AI that it can still protect us while allowing us to live on the new planet. “I used AI to assist with this entry.”

# April 13, 2026
Modern space technology is advanced, but it is not fully reliable for long missions yet. One important technology used in the Artemis II mission was the spacecraft’s onboard systems, which helped control the flight and keep astronauts safe during their journey. Another key technology was the communication system, which allowed astronauts to stay connected with Earth most of the time. These technologies played a crucial role in the mission’s success because they guided the spacecraft and helped monitor the crew’s condition. However, there were still challenges, like issues with the waste management system and a planned communication blackout when the spacecraft went behind the Moon. This shows that even highly developed technology can have limitations in extreme environments like space. Understanding these problems is essential because it helps engineers improve future missions and make them more efficient and dependable. “I used AI to assist with this entry.”

# April 20, 2026
AI is changing how people experience and trust music and media, and it does matter if content is made by a human or AI. For example, some AI-generated songs have become popular online, but many people feel disappointed when they find out a real person didn’t create them. Also, AI can make videos and posts that spread fast on social media and can influence what people think about real events, even if the information is not always true. This shows that AI can influence people the same way human content can, but it can also make it harder to know what is real. Human-made content often feels more personal because it comes from real experiences, while AI content can feel less genuine. Because of this, there should be limits on how AI is used in music and media, like requiring labels that show when something is AI-made. This would help people understand what they are seeing and make better choices about what to trust. “I used AI to assist with this entry.”
